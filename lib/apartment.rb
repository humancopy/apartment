...
module Apartment
  ...
  class << self
    ...
    WRITER_METHODS    = [:tenant_names, :database_schema_file, :excluded_models, :elevator, :default_schema, :persistent_schemas, :connection_class, :tld_length, :db_migrate_tenants, :seed_data_file]
